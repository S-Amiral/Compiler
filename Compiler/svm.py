...
SVM implements a very simplistic stack machine. It has a stack
(containing only numbers)
and a "central memory" that is adressable by names instead of adresses
(think "variables"...)
...
The format of svm's "bytecode" is the following:
    ...
    Valid opcodes are:
        ...
        PUSHV <id>: pushes the value of the identifier <id> on the execution
                    stack
    ...
    Example: this would be a valid "bytecode" file to print the numbers from 0
            to 9:
                    PUSHC 0.0
                    SET a
                    JMP cond1
    ...
    NB: whitespace is not significant in bytecode files.
        The identation above is for readability only.
